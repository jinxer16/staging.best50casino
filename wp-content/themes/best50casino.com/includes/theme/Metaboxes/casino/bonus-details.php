        ...
        <div class="col-12 p-0 country-bonus-section my_meta_control metabox" id="my_meta_control_country_<?= $iso ?>" data-country="<?= $iso?>">
            ...
            <div class="panel-collapse collapse" id="details-<?= $iso ?>">
                <div class="d-flex flex-wrap">
                    ...
                    <div class="col-6 p-3 d-flex flex-wrap align-items-baseline">
                        <label class="mb-0 mr-1 d-block w-100 text-center">Bonus Types</label>
                        <?php $mb->the_field($iso.$prefix.'bonus_types', WPALCHEMY_FIELD_HINT_CHECKBOX_MULTI);//WPALCHEMY_FIELD_HINT_CHECKBOX_MULTI ?>

                        <p class="mb-0 d-flex mr-1" style="width:31%">
                            <input type="checkbox" name="<?php $mb->the_name(); ?>" value="welcome_bonus"<?php $mb->the_checkbox_state('welcome_bonus'); ?>/>
                            <span class="w-80 <?php echo $mb->get_the_checkbox_state('welcome_bonus')!==null ? 'font-weight-bold':''; ?>"> Welcome Bonus</span>
                        </p>
                        <p class="mb-0 d-flex mr-1" style="width:31%">
                            <input type="checkbox" name="<?php $mb->the_name(); ?>" value="bonus_code"<?php $mb->the_checkbox_state('bonus_code'); ?>/>
                            <span class="w-80 <?php echo $mb->get_the_checkbox_state('bonus_code')!==null ? 'font-weight-bold':''; ?>"> Bonus Code</span>
                        </p>
                        <p class="mb-0 d-flex mr-1" style="width:31%">
                            <input type="checkbox" name="<?php $mb->the_name(); ?>" value="free_spins"<?php $mb->the_checkbox_state('free_spins'); ?>/>
                            <span class="w-80 <?php echo $mb->get_the_checkbox_state('free_spins')!==null ? 'font-weight-bold':''; ?>"> Free Spins  </span>
                        </p>
                        <p class="mb-0 d-flex mr-1" style="width:31%">
                            <input type="checkbox" name="<?php $mb->the_name(); ?>" value="live_casino_bonus"<?php $mb->the_checkbox_state('live_casino_bonus'); ?>/>
                            <span class="w-80 <?php echo $mb->get_the_checkbox_state('live_casino_bonus')!=null ? 'font-weight-bold':''; ?>"> Live Casino Bonus  </span>
                        </p>
                        <p class="mb-0 d-flex mr-1" style="width:31%">
                            <input type="checkbox" name="<?php $mb->the_name(); ?>" value="no_depo"<?php $mb->the_checkbox_state('no_depo'); ?>/>
                            <span class="w-80 <?php echo $mb->get_the_checkbox_state('no_depo')!=null ? 'font-weight-bold':''; ?>"> No Deposit Bonus  </span>
                        </p>
                        <p class="mb-0 d-flex mr-1" style="width:31%">
                            <input type="checkbox" name="<?php $mb->the_name(); ?>" value="reload_bonus"<?php $mb->the_checkbox_state('reload_bonus'); ?>/>
                            <span class="w-80 <?php echo $mb->get_the_checkbox_state('reload_bonus')!=null ? 'font-weight-bold':''; ?>"> Reload Bonus  </span>
                        </p>
                        <p class="mb-0 d-flex mr-1" style="width:31%">
                            <input type="checkbox" name="<?php $mb->the_name(); ?>" value="vip_bonus"<?php $mb->the_checkbox_state('vip_bonus'); ?>/>
                            <span class="w-80 <?php echo $mb->get_the_checkbox_state('vip_bonus')!=null ? 'font-weight-bold':''; ?>"> Vip Bonus </span>
                        </p>
                        <p class="mb-0 d-flex mr-1" style="width:31%">
                            <input type="checkbox" name="<?php $mb->the_name(); ?>" value="mobile_casino_bonus"<?php $mb->the_checkbox_state('mobile_casino_bonus'); ?>/>
                            <span class="w-80 <?php echo $mb->get_the_checkbox_state('mobile_casino_bonus')!=null ? 'font-weight-bold':''; ?>"> Mobile Casino Bonus </span>
                        </p>
