...
//                get_template_part('common-templates/casino-review-menu');
//            }
            ?>
            ...
            <div class="d-flex flex-wrap review-wrapper w-100 main">
                <?php
                    if (get_post_meta($post->ID,'casino_custom_meta_template',true) == "new"){
                        get_template_part('templates/post/content-kss_bonus-page-new');
                    }
                    else{
                        get_template_part('templates/post/content-kss_bonus-page');
                    }
                wp_reset_postdata();
                ?>
            </div>
