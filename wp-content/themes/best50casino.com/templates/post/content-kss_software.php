...
<?php }else{
	?>
	<h1 class="star"><?php echo get_post_meta($post->ID, 'software_custom_meta_seo_title', true); ?></h1>
	<?php
} ?>
<div class="entry">                    
	<?php the_content();
  ...
  <hr> 
<!--  <a class="catholic_link special col-sm-12" href="--><?php //echo get_site_url(); ?><!--/casino-providers/">See all Casino Providers</a>-->
</div>